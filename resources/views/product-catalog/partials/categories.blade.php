...
<div class="mi-card">
    ...
    <form method="GET" x-show="filtersOpen" x-transition>
        ...
        <div class="mi-filter-actions">
            ...
            <a href="{{ $catalogUrl('categories') }}" class="mi-btn-ghost">
                    ...
                    <tr>
                        ...
                        <td>
                            @if ($category->children_count > 0)
                                <a href="{{ $catalogUrl('categories', ['parent_id' => $category->id, 'display' => 'list']) }}" class="text-sm text-orange-600 hover:text-orange-700 font-medium">
