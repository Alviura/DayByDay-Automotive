<x-app-layout title="Procurement Report">
    ...
    <div class="mi-page space-y-5">
        <div class="flex justify-between gap-4">
            <div class="flex items-start gap-3">
                ...
                <div>
                    <h1 class="text-[1.35rem] font-bold">Procurement Report</h1>
        ...
        <div class="mi-kpi-row">
            <div class="mi-kpi mi-kpi-purple"><div><p class="mi-kpi-label">Open Folders</p><p class="mi-kpi-value">{{ $summary['folders_open'] }}</p></div></div>
            <div class="mi-kpi mi-kpi-amber"><div><p class="mi-kpi-label">New in Period</p><p class="mi-kpi-value">{{ $summary['folders_in_period'] }}</p></div></div>
        ...
        <div class="grid grid-cols-1 xl:grid-cols-2 gap-5">
            <div class="mi-card">
                <div class="mi-card-head"><span class="text-sm font-semibold">Folders by Status</span></div>
                <div class="mi-table-wrap">
                    <table class="mi-table">
                        ...
                        <tbody>
                            ...
                            @empty
                                <tr><td colspan="3" class="text-center py-8 text-gray-400">No folders.</td></tr>
                            @endforelse
                        </tbody>
                    </table>
                </div>
